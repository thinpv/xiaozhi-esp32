...
class ModuleStatusStartupRelay : public Module
{
protected:
	uint8_t status;
	string key;
...
public:
	ModuleStatusStartupRelay(Device *device, uint16_t addr, string keyString = "", uint32_t index = 0);
	~ModuleStatusStartupRelay();

...
DeviceBleWifiSwitchTouch::DeviceBleWifiSwitchTouch(string id, string name, string mac, uint32_t type, uint16_t addr, uint16_t version, Json::Value *dataJson, uint8_t countElement)
